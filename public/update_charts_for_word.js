...
// We will replace the entire function. Since it's at the end of the file (added by our last script), 
// we can just slice it from startIndex to the end.
const updatedLogic = `window.renderAllQuestionCharts = function() {
  ...
  // Render Chart.js - Optimized for MS Word (High contrast, white bg, dark text)
  ...
  const textColor = '#111827'; // Force high contrast black/dark gray for Word
  const gridColor = 'rgba(0,0,0,0.1)'; // Darker grid lines for visibility on white
...
console.log('admin.js updated for MS word charts');
